...
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=args.batch_size, shuffle=False, num_workers=16, drop_last=True)
...
EL2N(training_dynamics, trainset, data_importance, max_epoch=max_epoch)
